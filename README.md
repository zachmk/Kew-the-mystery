...
<head>
  ...
  <link rel="icon" type="image/png" href="path/to/your/favicon.png"> <!-- Replace with your favicon URL -->
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; }
    body { 
      ...
      background: linear-gradient(135deg, #0b3d0b, #002b5c); /* Dark green to dark blue */ 
      color: #f2f2f2; 
    }
    ...
    /* Header */
    header { 
      background: linear-gradient(90deg, #0a2d0a, #001f3d); /* dark green → dark blue */ 
      padding: 20px; 
      text-align: center; 
    ...
    .hero { 
      text-align: center; 
      padding: 50px 20px; 
      background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.6)), url('https://images.unsplash.com/photo-1603052875505-2b76a0b3fd97?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80') no-repeat center/cover; 
      color: #fff; 
    }
...
<body>
  ...
  <script>
    ...
    let firstFocusable, lastFocusable, lastFocusedButton;
